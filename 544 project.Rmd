...
descriptive <- merge(x = a, y = kenya_county_province_df[ , c("province", "county")], 
                     by.x = c("NAME_1"), 
                     by.y = c("county"))
...
```
Below, we provide a quantile-quantile plot comparing the direct estimates to a Gaussian distribution. Here the observed quantiles align well with those from a Gaussian distribution, which lends no support to the basic IID model.
